...
| amount | BigDecimal | Minimum 60.00, maximum 10000.00 | Payment amount |
...
- Payment amount must be at least 40.00 and is capped at 10000.00 per transaction by request validation.
...
Validation is implemented through Jakarta Bean Validation annotations in request DTOs and surfaced through GlobalExceptionHandler as HTTP 400 responses. Key constraints: amount minimum 40.00, amount maximum 10000.00, currency must be a 3-letter ISO code.
