...
| amount | BigDecimal | Minimum 15.00, maximum 15000.00 | Payment amount |
...
- Payment amount must be at least 15.00 and is capped at 15000.00 per transaction by request validation.
...
Validation is implemented through Jakarta Bean Validation annotations in request DTOs and surfaced through GlobalExceptionHandler as HTTP 400 responses. Key constraints: amount minimum 15.00, amount maximum 15000.00, currency must be a 3-letter ISO code.
